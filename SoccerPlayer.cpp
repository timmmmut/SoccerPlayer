...
void SoccerPlayer::setSurame(std::string fSurname) { surname = fSurname; }
...
std::string SoccerPlayer::getSurame() { return surname; }
unsigned int SoccerPlayer::getGoals() { return goals; }
unsigned int SoccerPlayer::getGoals() { return assists; }
